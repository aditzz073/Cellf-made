...
export default function ResultsPanel({ results, isLoading, patientId }) {
  ...
  return (
    <div style={styles.panel} className="fade-in">
      ...
      {/* ── Feature importances ── */}
      <SectionHeader icon={<GeneIcon />} title="Gene Feature Importances" />
      ...
      {/* ── Heatmap ── */}
      <SectionHeader icon={<HeatmapIcon />} title="Expression Heatmap" />
      <p style={styles.sectionDesc}>
...
function SectionHeader({ icon, title }) {
  return (
    <div style={styles.sectionHeader}>
      <span style={styles.sectionIconWrap}>{icon}</span>
  ...
  return (
    <div style={{ ...styles.interpBox, background: interp.bg, borderColor: interp.border }}>
      <div style={{ ...styles.interpHeading, color: interp.color }}>
        <span style={{ ...styles.interpDot, background: interp.color }} />
        {interp.heading}
      </div>
      ...
      <div style={styles.disclaimer}>
        <WarningIcon /> <strong>Research use only.</strong> This assessment is generated by an AI model and must
...
const WarningIcon = () => (
  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ verticalAlign: 'text-top' }} aria-hidden="true">
